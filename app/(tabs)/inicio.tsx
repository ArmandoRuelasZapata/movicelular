  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (status !== "granted") {
        Alert.alert(
          "Permiso denegado",
          "Se necesita permiso para buscar lugares.",
        );
        return;
      }
      ...
      if (result.length > 0) {
        ...
        if (isInsideDurango) {
          ...
          Alert.alert(
            ...
            "Solo se permite buscar dentro de Durango, Dgo.",
          );
        }
      } else {
        Alert.alert(
          "No encontrado",
          "No se encontraron resultados en Durango.",
        );
      }
    } catch (error) {
    ...
    <View style={GlobalStyles.container}>
      ...
      <View style={GlobalStyles.bottomNav}>
        ...
        >
          ...
          <Text style={[GlobalStyles.navText, GlobalStyles.textBase]}>
            Inicio
          </Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={[localStyles.navTextCenter, GlobalStyles.textBase]}>
            Crear reporte
          </Text>
        </TouchableOpacity>
