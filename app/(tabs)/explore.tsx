...
const PROFILE_DATA: ProfileData = {
    ...
    menuItems: [
        ...
        { id: 2, name: 'Tus reportes', icon: 'document-text-outline', screen: 'Reports' },
        { id: 3, name: 'Soporte y contacto', icon: 'call-outline', screen: 'Support' },
        { id: 4, name: 'Acerca de', icon: 'information-circle-outline', screen: 'About' },
        { id: 5, name: 'Cerrar sesión', icon: 'exit-outline', action: 'logout', isAction: true },
        { id: 6, name: 'Eliminar cuenta', icon: 'trash-outline', action: 'delete', isAction: true },
    ],
};
...
const ProfileScreen: React.FC = () => { 
    ...
    const handlePress = (item: MenuItem) => {
        ...
        if (item.name === 'Tus reportes') {
        router.push('/tusReportes'); // Nueva ruta
        return;
    }
