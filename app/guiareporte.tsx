        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.stepBox}>
            ...
            <Text style={styles.stepDescription}>
              ...
              <Text style={{ fontWeight: "bold" }}>(+)</Text> en el inicio de la
              aplicación.
            </Text>
          </View>
          ...
          <View style={styles.stepBox}>
            ...
            <Text style={styles.stepDescription}>
              Seleccione el tipo de incidencia (bache, calle bloqueada,
              accidente, etc.).
            </Text>
          </View>
          ...
          <View style={styles.stepBox}>
            ...
            <Text style={styles.stepDescription}>
              Rellene todos los campos obligatorios marcados con asterisco{" "}
          ...
          <View style={styles.stepBox}>
            ...
            <Text style={styles.stepDescription}>
              La app le devolverá un{" "}
              <Text style={{ fontWeight: "bold" }}>Token</Text> si la creación
              fue exitosa. ¡Guárdelo!
            </Text>
          </View>
        </ScrollView>
      </View>
